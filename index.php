...
padding-bottom:5px;
  ...
  <body>
  <nav class="navbar navbar-default navbar-fixed-top" id="navigation" style="opacity: 0.8; font-color:black;">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="Contact.php"><span class="glyphicon glyphicon-comments"></span>  Contact us</a></li>
  </ul>
    ...
    <div class="container">
        ...
        <h1>Welcome to Pata Keja</h1>
        <p>Get instant access to over 50+ hostels with just a click of a button</p>
        
        <p><a href="register.php" class="btn btn-info">Get started</a></p>
      </div>
    </div>
